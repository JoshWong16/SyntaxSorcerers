    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveCheckListButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SelectInterestsActivity.this, DisplayCourseRecommenderActivity.class);
        ...
        ServerRequest.ApiRequestListener apiRequestListener = new ServerRequest.ApiRequestListener() {
            ...
            public void onApiRequestComplete(JsonElement response) {
                if (!response.isJsonNull()) {
                    Toast.makeText(SelectInterestsActivity.this, "Interests List Received", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(SelectInterestsActivity.this, "Unable to Retrieve Interests List", Toast.LENGTH_SHORT).show();
                }
            }
